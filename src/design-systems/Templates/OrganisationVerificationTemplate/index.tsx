...
export const OrganisationVerificationTemplate: FC = () => {
          ...
          <div className={'flex w-full flex-col  lg:w-3/4'}>
            <div className="mt-8 flex flex-col">
              <div className="flex flex-col items-start" style={{ flexGrow: 1 }}>
                <div className="mb-1 text-base font-semibold dark:text-neutral-light-100">Legal business name</div>
              </div>
              <Input
            ...
            <div className="mt-8 flex flex-col">
              <div className="flex flex-col items-start" style={{ flexGrow: 1 }}>
                <div className="mb-1 text-base font-semibold dark:text-neutral-light-100">Business address</div>
              </div>
              <Input
            ...
            <div className="flex flex-col  items-center justify-start gap-0 slg:flex-row slg:gap-12">
              ...
              <div className="mt-8 flex  w-full flex-col">
                <div className="flex flex-col items-start" style={{ flexGrow: 1 }}>
                  <div className="mb-1 text-base font-semibold dark:text-neutral-light-100">Country</div>
                </div>
                <Input
                  className={`${inputClassName} w-full ${
